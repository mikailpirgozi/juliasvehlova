      ...
      <section className="bg-gradient-to-br from-[#8698a4] via-[#718593] to-[#5c6e7b] pb-8 pt-24 sm:pb-10 sm:pt-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn delay={0.1}>
            ...
            <h1 className="mt-3 font-serif text-3xl font-bold text-brand-200 sm:text-5xl lg:text-6xl">
              Kontakt
            </h1>
            <p className="mx-auto mt-4 max-w-xl text-base sm:text-lg text-white/75 px-2">
                  ...
                  <FadeIn key={i} delay={0.2 + i * 0.08}>
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="mt-0.5 font-semibold text-gray-900 group-hover:text-brand-700 transition-colors break-all">
                          {card.value}
                        </p>
          ...
          <FadeIn delay={0.2}>
            <div className="overflow-hidden rounded-3xl shadow-xl ring-1 ring-gray-200">
              <iframe
                ...
                width="100%"
                className="h-[260px] sm:h-[360px] lg:h-[420px]"
                style={{ border: 0 }}
                allowFullScreen
                loading="lazy"
          ...
          <FadeIn delay={0.2}>
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <p className="mt-1 text-sm font-bold text-gray-900 transition-colors group-hover:text-brand-700 break-all">juliaesteticclinic@gmail.com</p>
