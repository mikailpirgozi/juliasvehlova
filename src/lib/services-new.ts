    ...
    subcategories: [
      {
        ...
        services: [
          ...
          {
            id: 'radiesse-aktivna-vypln-15ml',
            slug: 'radiesse-aktivna-vypln-15-ml',
            name: 'Radiesse - aktívna výplň 1,5 ml',
            price: '400 €',
            duration: '20min.',
            bookioServiceId: '160138',
            tagline: 'Aktívna biostimulačná výplň',
            shortDescription: 'Radiesse pôsobí ako aktívna výplň a zároveň podporuje tvorbu vlastného kolagénu pre pevnejší vzhľad pokožky.',
            benefits: [
              { icon: 'firmness', title: 'Spevnenie pleti', description: 'Podpora pevnosti a kontúr' },
              { icon: 'collagen', title: 'Tvorba kolagénu', description: 'Stimulácia vlastnej produkcie' },
              { icon: 'lasting', title: 'Dlhodobý efekt', description: 'Postupné zlepšenie kvality pokožky' },
            ],
            forWhom: ['Pre stratu pevnosti pleti', 'Pre zlepšenie kontúr', 'Pre biostimulačné omladenie'],
          },
          {
            id: 'radiesse-aktivna-vypln-3ml',
            slug: 'radiesse-aktivna-vypln-3-ml',
            name: 'Radiesse - aktívna výplň 3 ml',
            price: '580 €',
            duration: '20min.',
            bookioServiceId: '160139',
            tagline: 'Aktívna biostimulačná výplň',
            shortDescription: 'Radiesse pôsobí ako aktívna výplň a zároveň podporuje tvorbu vlastného kolagénu pre pevnejší vzhľad pokožky.',
            benefits: [
              { icon: 'firmness', title: 'Spevnenie pleti', description: 'Podpora pevnosti a kontúr' },
          ...
          },
          {
            ...
            price: '300 €',
            duration: '20min.',
            bookioServiceId: '84155',
            tagline: 'Švajčiarska kvalita',
            shortDescription: 'Prémiový skin booster od Teosyal pre hlbokú hydratáciu a žiarivosť.',
          },
          {
            id: 'tripple-booster',
            slug: 'tripple-booster',
            name: 'Tripple Booster',
            price: '330 €',
            duration: '30min.',
            bookioServiceId: '163659',
            tagline: 'Najintenzívnejšie bunkové omladenie',
            shortDescription: 'Exkluzívny lekársky protokol spájajúci silu exozómov, polynukleotidov a kolagénového komplexu pre regeneráciu pleti na bunkovej úrovni.',
            fullDescription: 'Najintenzívnejšia verzia nášho bunkového omladenia vykonávaná lekárkou. Exkluzívny protokol spája silu exozómov, polynukleotidov a kolagénového komplexu. Ošetrenie cielene regeneruje pokožku na bunkovej úrovni, stimuluje tvorbu kolagénu a obnovuje kvalitu kože bez zmeny prirodzenej mimiky či objemu tváre. Lekárska aplikácia umožňuje maximálne presné ošetrenie problematických oblastí a individuálne nastavenie podľa potrieb pleti. Vhodné pri ochabnutej pleti, jemných vráskach, strate elasticity, unavenej a dehydrovanej pleti aj ako prevencia starnutia. Výsledok: pevnejšia, zdravšia a viditeľne omladená pleť s prirodzeným efektom bez umelého objemu.',
            benefits: [
              { icon: 'regeneration', title: 'Intenzívna regenerácia', description: 'Obnova kože na bunkovej úrovni' },
              { icon: 'collagen', title: 'Tvorba kolagénu', description: 'Stimulácia vlastnej produkcie' },
              { icon: 'firmness', title: 'Spevnenie a rozjasnenie', description: 'Pevnejšia a žiarivejšia pleť' },
              { icon: 'youthful', title: 'Prirodzený anti-aging', description: 'Dlhodobé omladenie bez objemu' },
            ],
            forWhom: ['Pre ochabnutú pleť a stratu elasticity', 'Pre jemné vrásky a unavenú pleť', 'Pre prevenciu starnutia'],
          },
        ],
      },
      {
  ...
  // ========================================
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        bookioCategoryId: '35824',
        services: [
          {
            id: 'bio-c-peeling',
            slug: 'bio-c-peeling',
            name: 'Bio C peeling',
            bookioServiceId: '109004',
            price: '60 €',
            duration: '30min.',
      ...
      },
      {
        ...
        services: [
          ...
          {
            id: 'tripple-booster-microneedling',
            slug: 'tripple-booster-microneedling',
            name: 'Tripple Booster Microneedling',
            price: '180 €',
            duration: '1h 30min.',
            bookioServiceId: '163661',
            tagline: 'Lekársky microneedling s bunkovým koktejlom',
            shortDescription: 'Kombinácia exozómov, polynukleotidov a kolagénu aplikovaná lekárskym microneedlingom pre regeneráciu, tvorbu kolagénu a spevnenie pleti.',
            fullDescription: 'Intenzívne omladzujúce ošetrenie pomocou lekárskeho microneedlingu a bunkového koktejlu novej generácie. Kombinácia exozómov, polynukleotidov a kolagénu podporuje regeneráciu kože, tvorbu nového kolagénu a prirodzené spevnenie pleti. Tisíce mikrokanálikov umožnia účinným látkam preniknúť hlboko do pokožky, kde aktivujú bunkovú obnovu, zlepšujú elasticitu a rozjasňujú unavenú pleť. Vhodné pri jemných vráskach, rozšírených póroch, jazvičkách po akné, ochabnutej pleti aj pri strate jasu a hydratácie. Výsledok: hladšia, pevnejšia a zdravšie pôsobiaca pleť už po niekoľkých ošetreniach.',
            benefits: [
              { icon: 'collagen', title: 'Tvorba kolagénu', description: 'Stimulácia vlastnej produkcie' },
              { icon: 'regeneration', title: 'Regenerácia pokožky', description: 'Aktivácia bunkovej obnovy' },
              { icon: 'texture', title: 'Zlepšenie textúry', description: 'Jemnejšia a hladšia pleť' },
              { icon: 'glow', title: 'Rozjasnenie a hydratácia', description: 'Svieži a žiarivý vzhľad' },
            ],
            forWhom: ['Pre jemné vrásky a rozšírené póry', 'Pre jazvičky po akné', 'Pre ochabnutú pleť a stratu jasu'],
          },
          {
            id: 'tripple-booster-vital-injector',
            slug: 'tripple-booster-vital-injector',
            name: 'Tripple Booster Vital Injector',
            price: '230 €',
            duration: '1h 30min.',
            bookioServiceId: '163662',
            tagline: 'Presná hĺbková aplikácia bunkového koktejlu',
            shortDescription: 'Hĺbkové ošetrenie Vital Injectorom, ktorý rovnomerne aplikuje polynukleotidy, exozómy a kolagénový komplex pomocou viacbodového systému mikro-vpichov.',
            fullDescription: 'Precízne hĺbkové ošetrenie pomocou Vital Injectora, ktorý aplikuje bunkový koktejl rovnomerne do pokožky pomocou viacbodového systému mikro-vpichov. Ošetrenie kombinuje polynukleotidy, exozómy a kolagénový komplex, pričom táto kombinácia podporuje regeneráciu buniek, obnovu kolagénových vlákien a intenzívnu revitalizáciu pleti bez umelého objemu. Vital Injector zabezpečuje maximálne presnú aplikáciu účinných látok do optimálnej hĺbky, čo prináša výrazné spevnenie, hydratáciu a rozjasnenie pleti. Vhodné pri unavenej pleti, strate elasticity, dehydratácii, jemných vráskach aj mdlej a ochabnutej pokožke. Výsledok: viditeľne sviežejšia, pevnejšia a kvalitnejšia pleť s prirodzeným glow efektom.',
            benefits: [
              { icon: 'regeneration', title: 'Hĺbková regenerácia', description: 'Obnova kolagénových vlákien' },
              { icon: 'hydration', title: 'Intenzívna hydratácia', description: 'Hĺbkové zvlhčenie pleti' },
              { icon: 'firmness', title: 'Spevnenie pleti', description: 'Výraznejšie kontúry' },
              { icon: 'glow', title: 'Rozjasnenie a glow', description: 'Prirodzený omladzujúci efekt' },
            ],
            forWhom: ['Pre unavenú pleť a stratu elasticity', 'Pre dehydratáciu a jemné vrásky', 'Pre mdlú a ochabnutú pokožku'],
          },
        ],
      },
      {
        ...
        services: [
          // Laminácia
          {
            ...
            bookioServiceId: '149062',
            bookioCategoryId: '35828',
            price: '20 €',
            duration: '30min.',
          ...
          // Permanentný make-up
          {
            ...
            bookioServiceId: '84134',
            bookioCategoryId: '35829',
            price: '100 €',
            duration: '1h',
          ...
          },
          {
            ...
            bookioServiceId: '84036',
            bookioCategoryId: '35827',
            price: '200 €',
            duration: '2h',
            popular: true,
  ...
  // ========================================
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        bookioCategoryId: '35832',
        services: [
          {
            id: 'laser-brucho-p',
            slug: 'laserova-epilacia-brucho-pani',
            name: 'Laserová epilácia - Brucho',
            bookioServiceId: '84065',
            price: '80 €',
            duration: '30min.',
    ...
    subcategories: [
      {
        ...
        bookioCategoryId: '35602',
        services: [
          {
            id: 'masaz-60',
            slug: '60-minutova-masaz',
            name: '60 minútová masáž',
            bookioServiceId: '148095',
            price: '40 €',
            duration: '1h',
  ...
  // ========================================
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        bookioCategoryId: '35604',
        services: [
          {
            id: 'conch-piercing',
            slug: 'conch-piercing',
            name: 'Conch piercing',
            bookioServiceId: '148099',
            price: '35 €',
            duration: '15min.',
      ...
      },
      {
        ...
        bookioCategoryId: '35603',
        services: [
          {
            id: 'lobe-piercing',
            slug: 'lobe-piercing',
            name: 'Lobe piercing',
            bookioServiceId: '148090',
            price: '25 €',
            duration: '10min.',
            popular: true,
    ...
    services: [
      {
        ...
        slug: 'denne-licenie',
        name: 'Denné líčenie',
        bookioServiceId: '84042',
        bookioCategoryId: '19763',
        price: '100 €',
        duration: '1h',
    ...
    services: [
      {
        ...
        slug: 'tetovanie',
        name: 'Tetovanie',
        bookioServiceId: '149068',
        bookioCategoryId: '35825',
        price: '50 €',
        duration: '1h',
        tagline: 'Profesionálne tetovanie',
        shortDescription: 'Profesionálne tetovanie vykonané skúseným tattoo artistom v sterilnom prostredí.',
      },
    ],
  },
    ...
    services: [
      {
        ...
        bookioServiceId: '85180',
        bookioCategoryId: '20121',
    ...
    services: [
      {
        ...
        bookioServiceId: '101740',
        bookioCategoryId: '23896',
        price: '200 €',
        duration: '2h',
        popular: true,
