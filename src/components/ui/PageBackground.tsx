...
export function PageBackground({
  ...
  return (
    <div className={`${baseStyles} ${variantStyles[variant]} ${className}`}>
      ...
      <div className="pointer-events-none absolute bottom-20 left-10 h-80 w-80 rounded-full bg-[#8698a4]/15 blur-3xl" />
      ...
      <div className="pointer-events-none absolute top-1/4 left-1/4 h-32 w-32 rounded-full bg-[#8698a4]/10 blur-2xl" />
...
export function SectionBackground({
  ...
  const variantStyles = {
    ...
    accent: 'bg-gradient-to-br from-brand-100/50 via-brand-50/30 to-[#8698a4]/10',
    white: 'bg-white',
  }
  ...
  return (
    <div className={`relative overflow-hidden ${variantStyles[variant]} ${className}`}>
      ...
      <div className="pointer-events-none absolute -bottom-20 -left-20 h-40 w-40 rounded-full bg-[#8698a4]/12 blur-3xl" />
