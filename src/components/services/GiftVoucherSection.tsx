...
export function GiftVoucherSection() {
  return (
    <section className="relative z-10 overflow-hidden bg-gradient-to-br from-[#CDA882]/10 via-white to-brand-50/30 px-4 py-16">
      {/* Decorative elements */}
      <div className="pointer-events-none absolute -left-20 top-1/4 h-64 w-64 rounded-full bg-[#CDA882]/20 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#CDA882] to-[#B8956E] shadow-lg">
