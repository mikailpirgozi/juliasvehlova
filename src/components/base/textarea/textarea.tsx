...
export const TextAreaBase = ({ className, ...props }: TextAreaBaseProps) => {
    return (
        <AriaTextArea
            ...
            className={(state) =>
                cx(
                    "w-full scroll-py-3 rounded-lg bg-white px-3.5 py-3 text-md text-gray-900 shadow-xs ring-1 ring-gray-300 transition duration-100 ease-linear ring-inset placeholder:text-gray-500 autofill:rounded-lg autofill:text-gray-900 focus:outline-hidden",
