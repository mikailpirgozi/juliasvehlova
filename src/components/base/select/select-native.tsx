        ...
        <div className={cx("w-full in-data-input-wrapper:w-max", className)}>
            ...
            <div className="relative grid w-full items-center">
                <select
                    ...
                    className={cx(
                        "appearance-none rounded-lg bg-white px-3.5 py-2.5 text-md font-medium text-gray-900 shadow-xs ring-1 ring-gray-300 outline-hidden transition duration-100 ease-linear ring-inset placeholder:text-gray-500 focus-visible:ring-2 focus-visible:ring-brand-500 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-400",
