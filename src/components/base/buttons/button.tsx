...
export const styles = sortCx({
    ...
    colors: {
        ...
        secondary: {
            root: [
                "bg-white text-gray-700 shadow-xs-skeumorphic ring-1 ring-gray-300 ring-inset hover:bg-gray-50 hover:text-gray-800 data-loading:bg-gray-50",
                // Disabled styles
                "disabled:shadow-xs disabled:ring-gray-200",
                // Icon styles
        ...
        tertiary: {
            root: [
                "text-gray-600 hover:bg-gray-50 hover:text-gray-700 data-loading:bg-gray-50",
                // Icon styles
                "*:data-icon:text-gray-500 hover:*:data-icon:text-gray-600",
            ].join(" "),
        },
        ...
        "secondary-destructive": {
            root: [
                "bg-white text-error-600 shadow-xs-skeumorphic ring-1 ring-error-300 outline-error ring-inset hover:bg-error-50 hover:text-error-700 data-loading:bg-error-50",
                // Disabled styles
                "disabled:bg-white disabled:shadow-xs disabled:ring-gray-200",
                // Icon styles
        ...
        "tertiary-destructive": {
            root: [
                "text-error-600 outline-error hover:bg-error-50 hover:text-error-700 data-loading:bg-error-50",
                // Icon styles
                "*:data-icon:text-error-500 hover:*:data-icon:text-error-600",
            ].join(" "),
        },
